...
while continue_reading:
  ...
  #seleccionar el tipo de alerta de enviar
  if rfidStatus ==1:
      print ("Tarjeta Valida")
      lcd.set_color(0.0, 1.0, 1.0)
      lcd.clear()
      lcd.message('Tarjeta Valida')
      time.sleep(1)#lee cual de los botones esta siendo pulsado
      if input_state1 == False:
          print("Button1 Pressed")
          data= {"value":"1", "name":"Magg"}
      ...
      data=0
      firebase.post('/Alerts/Status',data)
      print ("Community System")
