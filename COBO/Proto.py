...
firebase = firebase.FirebaseApplication('https://tests01.firebaseio.com', None)
...
show_main_screen()
while not done:
        alert_status = firebase.get('tests01/status',None)
        if alert_status != last_status:
