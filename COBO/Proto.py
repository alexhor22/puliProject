...
images_path = 'C:/Users/aleja/Documents/puliProject/COBO/images/'#'/home/pi/Documents/puliProject/COBO/images/'#'C:/Users/aleja/Documents/puliProject/COBO/images/'
...
if __name__ == '__main__':             
        ...
        while not done:
                try:
                        payload = {'colonia': 'Primavera'} # 'Primavera' is fixed, needs to be changed 
                        r = requests.get("http://puliapi.herokuapp.com/getStatus", params=payload)
                        # alert_status = firebase.get('Board/Status',None)
                        alert_status = r.json()['status']
                                        ...
                                        if main_screen_is_showing:
                                                if   0.359375 <= y/float(screen_heigth)  and  y/float(screen_heigth) <= 0.75625: #IS IN Y RANGE
                                                        if 0.0479166666667 <= x/float(screen_width) and x/float(screen_width) <= 0.304166666667:
                                                                ...
                                                                payload = {'colonia': 'Primavera','status':2}
                                                                requests.get("http://puliapi.herokuapp.com/changeStatus", params=payload)
                                                                ...
                                                                payload = {'colonia': 'Primavera','status':1}
                                                                requests.get("http://puliapi.herokuapp.com/changeStatus", params=payload)
                                                                i_sended_the_alert = True
                                                                ...
                                                                payload = {'colonia': 'Primavera','status':3}
                                                                requests.get("http://puliapi.herokuapp.com/changeStatus", params=payload)
                                                                i_sended_the_alert = True
                                        else:
                                                if ( 0.816666666667 <= x/float(screen_width) and x/float(screen_width) <= 0.966666666667) and (0.728125<= y/float(screen_heigth) and y/float(screen_heigth) <= 0.953125) and i_sended_the_alert:
                                                        ...
                                                        payload = {'colonia': 'Primavera','status':0}
                                                        requests.get("http://puliapi.herokuapp.com/changeStatus", params=payload)
